        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecipientTeam = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "DocumentTaskAttachments",
                columns: table => new
                {
                    DocumentTaskAttachmentId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    DocumentId = table.Column<int>(type: "INTEGER", nullable: false),
                    TaskId = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocumentTaskAttachments", x => x.DocumentTaskAttachmentId);
                    table.ForeignKey(
                        name: "FK_DocumentTaskAttachments_Documents_DocumentId",
                        column: x => x.DocumentId,
                        principalTable: "Documents",
                        principalColumn: "DocumentId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DocumentTaskAttachments_Tasks_TaskId",
                        column: x => x.TaskId,
                        principalTable: "Tasks",
                        principalColumn: "TaskId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DocumentTaskAttachments_Users_AttachedByUserId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, new DateTime(2026, 4, 14, 2, 32, 53, 640, DateTimeKind.Utc).AddTicks(4482), "IT", "System Administrator", "admin@contoso.com", true, true, "Administrator", null, null, null, 3 },
                    { 2, 0, new DateTime(2026, 4, 14, 2, 32, 53, 640, DateTimeKind.Utc).AddTicks(4485), "Engineering", "Camille Nicole", "camille.nicole@contoso.com", true, true, "Project Manager", null, null, null, 2 },
                    { 3, 0, new DateTime(2026, 4, 14, 2, 32, 53, 640, DateTimeKind.Utc).AddTicks(4488), "Engineering", "Floris Kregel", "floris.kregel@contoso.com", true, true, "Team Lead", null, null, null, 1 },
                    { 4, 0, new DateTime(2026, 4, 14, 2, 32, 53, 640, DateTimeKind.Utc).AddTicks(4490), "Engineering", "Ni Kang", "ni.kang@contoso.com", true, true, "Software Engineer", null, null, null, 0 }
                });

            migrationBuilder.InsertData(
                table: "Announcements",
                columns: new[] { "AnnouncementId", "Content", "CreatedByUserId", "ExpiryDate", "IsActive", "PublishDate", "Title" },
                values: new object[] { 1, "Welcome to the new ContosoDashboard application. This platform will help you manage your tasks and projects more efficiently.", 1, new DateTime(2026, 5, 14, 2, 32, 53, 640, DateTimeKind.Utc).AddTicks(4686), true, new DateTime(2026, 4, 14, 2, 32, 53, 640, DateTimeKind.Utc).AddTicks(4686), "Welcome to ContosoDashboard" });

            migrationBuilder.InsertData(
                table: "Projects",
                columns: new[] { "ProjectId", "CreatedDate", "Description", "Name", "ProjectManagerId", "StartDate", "Status", "TargetCompletionDate", "UpdatedDate" },
                values: new object[] { 1, new DateTime(2026, 3, 15, 2, 32, 53, 640, DateTimeKind.Utc).AddTicks(4605), "Internal employee productivity dashboard", "ContosoDashboard Development", 2, new DateTime(2026, 3, 15, 2, 32, 53, 640, DateTimeKind.Utc).AddTicks(4600), 1, new DateTime(2026, 6, 13, 2, 32, 53, 640, DateTimeKind.Utc).AddTicks(4603), new DateTime(2026, 4, 14, 2, 32, 53, 640, DateTimeKind.Utc).AddTicks(4606) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 3, 15, 2, 32, 53, 640, DateTimeKind.Utc).AddTicks(4661), 1, "TeamLead", 3 },
                    { 2, new DateTime(2026, 3, 15, 2, 32, 53, 640, DateTimeKind.Utc).AddTicks(4663), 1, "Developer", 4 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 4, 2, new DateTime(2026, 3, 15, 2, 32, 53, 640, DateTimeKind.Utc).AddTicks(4627), "Create entity relationship diagram and database design", new DateTime(2026, 3, 25, 2, 32, 53, 640, DateTimeKind.Utc).AddTicks(4626), 2, 1, 2, "Design database schema", new DateTime(2026, 3, 25, 2, 32, 53, 640, DateTimeKind.Utc).AddTicks(4628) },
                    { 2, 4, 2, new DateTime(2026, 3, 20, 2, 32, 53, 640, DateTimeKind.Utc).AddTicks(4631), "Set up Microsoft Entra ID authentication", new DateTime(2026, 4, 19, 2, 32, 53, 640, DateTimeKind.Utc).AddTicks(4630), 3, 1, 1, "Implement authentication", new DateTime(2026, 4, 14, 2, 32, 53, 640, DateTimeKind.Utc).AddTicks(4632) },
                    { 3, 4, 2, new DateTime(2026, 3, 25, 2, 32, 53, 640, DateTimeKind.Utc).AddTicks(4635), "Design user interface mockups for all main pages", new DateTime(2026, 4, 24, 2, 32, 53, 640, DateTimeKind.Utc).AddTicks(4634), 1, 1, 0, "Create UI mockups", new DateTime(2026, 3, 25, 2, 32, 53, 640, DateTimeKind.Utc).AddTicks(4635) }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentTaskAttachments_AttachedByUserId",
                table: "DocumentTaskAttachments",
                column: "AttachedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_DocumentTaskAttachments_DocumentId",
                table: "DocumentTaskAttachments",
                column: "DocumentId");

            migrationBuilder.CreateIndex(
                name: "IX_DocumentTaskAttachments_TaskId",
                table: "DocumentTaskAttachments",
                column: "TaskId");
